...
import * as data from './json_ingredient_lists/tins.json';

class TinnedChecklist extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      initialList: {},
  ...
  componentDidMount(){
    console.log("TinnedChecklist unmounted")
  ...
  componentDidUpdate(){
    console.log("TinnedChecklist did update")
