...
import * as data from './json_ingredient_lists/fruits_vegs.json';
...
class FruitAndVegChecklist extends React.Component {
  ...
  componentDidMount(){
    console.log("FruitAndVegChecklist mounted")
  ...
  componentWillUnmount(){
    console.log("FruitAndVegChecklist unmounted")
  }
  ...
  componentDidUpdate(){
    console.log("FruitAndVegChecklist did update")
