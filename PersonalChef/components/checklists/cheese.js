...
import * as data from './json_ingredient_lists/cheese.json';


class CheeseChecklist extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      initialList: {},
  ...
  componentDidMount(){
    console.log("CheeseChecklist mounted")
  ...
  componentWillUnmount(){
    console.log("CheeseChecklist unmounted")
  }
  ...
  componentDidUpdate(){
    console.log("CheeseChecklist did update")
